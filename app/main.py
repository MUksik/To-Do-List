...
st.markdown(f"""
<style>
  @font-face {{ font-family: "ROG"; src: url("data:font/ttf;base64,{base64.b64encode(open("assets/ROG.ttf", "rb").read()).decode()}") format("truetype"); }}
  .stApp, .stApp * {{ font-family: "ROG" !important; }}
...
new_task = st.text_input("wpisz treść:", value=ss.task_input)
